...
class MainWindow(QMainWindow):
    ...
    def make_buttons(self):
        ...
        autoROIeditYes.setShortcut("[")
        autoROIeditNo = QPushButton("]:NotCell", self)
        self.l0.addWidget(autoROIeditNo, b0, 1, 1, 1)
        autoROIeditNo.clicked.connect(self.choiceNo)
        autoROIeditNo.setShortcut("]")
        b0+=1
        autoROIback = QPushButton("\:back")
        ...
        self.l0.addWidget(self.zoomSlider,b0, 13,1,2)
        self.zoomSlider.setMaximum(200)
        self.zoomSlider.valueChanged.connect(self.zoom_to_cell)
    ...
    def zoom_to_cell(self):
        ...
        if len(self.imerge) > 1:
            ...
            imin = icent - irange
            imax = icent + irange
        self.p1.setYRange(imin[0]-self.zoomSlider.value(), imax[0]+self.zoomSlider.value())
        self.p1.setXRange(imin[1]-self.zoomSlider.value(), imax[1]+self.zoomSlider.value())
        self.p2.setYRange(imin[0]-self.zoomSlider.value(), imax[0]+self.zoomSlider.value())
        self.p2.setXRange(imin[1]-self.zoomSlider.value(), imax[1]+self.zoomSlider.value())
        self.win.show()
        self.show()
